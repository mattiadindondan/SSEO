...
deltaP_feed=(1/2*rho_MON*v_feed^2)*1.01325; % [bar] (converted from atm) deltaP feed
P_tank=(P_chamber+deltaP_feed+deltaP_inj)*10^5; % [Pa] (converted from bar) Tank Pressure
